...
class ModalityMissPretrainModel(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        self.teacher_model = MultiFusionMultiModel(self.teacher_config)
    ...
    def forward(self):
        ...
        if self.isTrain:
            with torch.no_grad():
                ...
                self.teacher_ef_fusion = self.teacher_model.ef_reps
