...
cmd="python train_miss_mix_base.py --dataset_mode=iemocap_miss --model=CRA_simple2 --gpu_ids=2
...
--AE_layers=256,256,128 --n_blocks=5
...
--name=cra_simple_c_miss --suffix=AE{AE_layers}_run{run_idx}
--cvNo=$i"
