...
cmd="python train_kd.py --dataset_mode=iemocap_miss --model=modality_miss_ts --gpu_ids=5
...
--ce_weight=1 --kd_weight=0 --mmd_weight=0.1 --kd_temp=2
--niter=30 --niter_decay=70 --verbose --kd_fix_iter=10 --kd_loss_type=BCE
--batch_size=256 --lr=5e-4 --dropout_rate=0.5 --run_idx=2
--miss_num=1 --miss2_rate=0.5
