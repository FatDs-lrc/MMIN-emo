...
cmd="python train_miss_mix_base.py --dataset_mode=iemocap_miss --model=new_CRA --gpu_ids=4
...
--AE_layers=256,128,64 --n_blocks=7
...
--name=CRA_block_ablation --suffix=AE{AE_layers}_blocks{n_blocks}_run{run_idx}
--cvNo=$i"
